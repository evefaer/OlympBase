...
import { Rocket, Calendar, List, Moon, Sun, Bell, BellRing } from "lucide-react";
...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-border bg-card/80 backdrop-blur-md" style={{ paddingTop: 'env(safe-area-inset-top)' }}>
